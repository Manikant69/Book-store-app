            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
                <div className=' order-2 md:order-1 w-full md:w-1/2 md:mt-32 mt-12'>
                    <div className='space-y-8'>
                        ...
                        <p className='text-sm md:text-xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolores quo suscipit accusamus? Blanditiis aspernatur, eligendi dolor, est eaque alias aut natus, nulla delectus aliquam inventore. </p>
